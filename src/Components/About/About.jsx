            ...
            <div className="about__data grid">
              <div className="about__info">
                <p className="about__description">
                  Enthusiastic Frontend Developer hailing from India, skilled in
                  React.js. Transforming design visions into captivating web
                  interfaces, I bring a blend of creativity and technical
                  prowess. Committed to crafting seamless user experiences, I
                  thrive on pushing boundaries and contributing to the
                  ever-evolving landscape of web development.
                </p>
                <a href={pdffile} target="_blank" className="btn">
                  {" "}
                  Download CV
                </a>
              </div>
